...
const Contact: React.FC = () => {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const name = form.current.username.value;
    const email = form.current.email.value;
    const msg = form.current.project.value;
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">upgraderboy@gmail.com</span>
              <a href="mailto:upgraderboy@gmail.com" className="contact__button">
            ...
            <div className="contact__card">
              ...
              <a href="https://api.whatsapp.com/send?phone=+918890309622&text=hii Upgrader Boy 😎, more information!" className="contact__button">
                Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
            <div className="contact__card">
              ...
              <a href="https://www.instagram.com/upgraderboy" className="contact__button">
                Write Me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
              </a>
            </div>
          </div>
        ...
        <div className="contact__content">
          ...
          <form className="contact__form" ref={form} onSubmit={sendEmail}>
            <div className="contact__form-div">
              ...
              <input type="text" name="username" className="contact__form-input" placeholder="Insert Your Name" />
            </div>
            <div className="contact__form-div">
            ...
            <div className="contact__form-div contact__form-area">
              <label htmlFor="project" className="contact__form-tag">Project Description</label>
              <textarea cols={30} rows={10} name="project" className="contact__form-input" placeholder="Information About Your Project"></textarea>
            </div>
